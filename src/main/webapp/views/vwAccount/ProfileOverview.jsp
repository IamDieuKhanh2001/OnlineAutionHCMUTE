            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Thay đổi avatar</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="${pageContext.request.contextPath}/Account/StoreAvatar" method="post" id="frmSaveAvatar" enctype="multipart/form-data" accept-charset="UTF-8">
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="InputAvatar">Hãy chọn ảnh Waifu của bạn</label>
                                <input id="InputAvatar" name="avatar" type="file"/>
                            </div>
                        </div>
