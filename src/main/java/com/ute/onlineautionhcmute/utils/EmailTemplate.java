...
public class EmailTemplate {
    ...
    public static String TemplateRecoverAccount2(User user, String code)
    {
        String email = "\n" +
                "<!doctype html>\n" +
                "<html lang=\"en-US\">\n" +
                ...
                "                    <tr>\n" +
                "                        <td style=\"text-align:center;\">\n" +
                "                            <p style=\"font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;\">&copy; <strong>Online Aution HCMUTE</strong></p>\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <tr>\n" +
                "                        <td style=\"height:80px;\">&nbsp;</td>\n" +
    ...
    public static String TemplateChangePasswordNotification(User user)
    {
        String message = "<!doctype html>\n" +
                ...
                "                    <tr>\n" +
                "                        <td style=\"text-align:center;\">\n" +
                "                            <p style=\"font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;\">&copy; <strong>Online Auction HCMUTE</strong></p>\n" +
                "                        </td>\n" +
                "                    </tr>\n" +
                "                    <tr>\n" +
                "                        <td style=\"height:80px;\">&nbsp;</td>\n" +
    ...
    public static String TemplateConfirmNewEmail(EmailConfirm emailConfirm,String URL)
    {
        String message = "<!doctype html>\n" +
                ...
                "                                <tr>\n" +
                "                                    <td style=\"padding:0 35px;\">\n" +
                "                                        <h1 style=\"color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;\">Please confirm new email</h1>\n" +
                "                                        <span\n" +
                "                                            style=\"display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;\"></span>\n" +
                "                                        <p style=\"color:#455056; font-size:15px;line-height:24px; margin:0;\">\n" +
                "                                            We've received a new email confirmation request from this email address, if this is your account. Please click the link below to confirm\n" +
                "                                        </p>\n" +
                "                                        <a href=\"[link]\"\n" +
    ...
    public static String TemplateNotification(String title, String content)
    {
        String message = "<!doctype html>\n" +
                "<html lang=\"en-US\">\n" +
                "\n" +
