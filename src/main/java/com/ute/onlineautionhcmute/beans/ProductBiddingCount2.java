...
public class ProductBiddingCount2 {
    private int id;
    private String name;
    ...
    public ProductBiddingCount2(int id, String name, String description, int product_type_id, int user_id, double price_start, double price_step, double price_current, double price_buy_now, Date end_time, int user_id_holding_price, Date create_time, Date modified_time, int quantity) {
        this.id = id;
        this.name = name;
